 ...
 *
 * функция myPrint(a, b, res) – глобальная функция, которая
 * должна генерировать из параметров a, b, res строку вида 'a^b=res' и возвращать ее
 *
...
function myPow(a, b, myPrint) {
  ...
  for (let i = 1; i < b; i++) pow *= a;

  return myPrint(a, b, pow);
}

console.log('-------------------------------------');
console.log('myPow(3, 4, myPrint): ', myPow(3, 4, myPrint));
console.log('myPow(2, 3, myPrint): ', myPow(2, 3, myPrint));
